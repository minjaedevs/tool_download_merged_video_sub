...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_load_txt = QAction(MainWindow)
        self.action_load_txt.setObjectName(u"action_load_txt")
        ...
        self.lb_sub_url = QLabel(self.gb_params)
        self.lb_sub_url.setObjectName(u"lb_sub_url")
        self.lb_sub_url.setMinimumSize(QSize(0, 0))

        self.gridLayout.addWidget(self.lb_sub_url, 1, 0, 1, 1)

        self.le_sub_url = QLineEdit(self.gb_params)
        self.le_sub_url.setObjectName(u"le_sub_url")

        self.gridLayout.addWidget(self.le_sub_url, 1, 1, 1, 4)
        ...
        self.gridLayout.addWidget(self.dd_preset, 3, 3, 1, 1)
        ...
        self.menuFile.addAction(self.action_load_txt)
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.action_exit)
        self.menuHelp.addAction(self.action_help)
        self.menuHelp.addAction(self.action_check_update)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_load_txt.setText(QCoreApplication.translate("MainWindow", u"Load .txt...", None))
        self.action_check_update.setText(QCoreApplication.translate("MainWindow", u"Kiem tra cap nhat", None))
        ...
        self.lb_sub_url.setText(QCoreApplication.translate("MainWindow", u"Sub URL", None))
        self.le_sub_url.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Tu chon", None))
        ...
        ___qtreewidgetitem.setText(7, QCoreApplication.translate("MainWindow", u"Sub", None));
